...
def set_initial_colours(device_info: dict, shared_var) -> None:
    ...
    try:
        ...
        shared_var.update_user_colors(add_alpha_to_rgb(user_alpha, user_colors))
        shared_var.update_rooms_colors(add_alpha_to_rgb(rooms_alpha, rooms_colors))
